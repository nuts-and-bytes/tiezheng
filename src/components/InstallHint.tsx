...
export function InstallHint() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-[calc(env(safe-area-inset-bottom)+80px)] z-40 mx-auto flex max-w-md items-center gap-3 rounded-2xl border border-line bg-card p-4 text-sm shadow-lg">
